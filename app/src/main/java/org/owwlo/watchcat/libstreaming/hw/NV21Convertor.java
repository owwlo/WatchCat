...
package org.owwlo.watchcat.libstreaming.hw;
...
public class NV21Convertor {
    private static String TAG = NV21Convertor.class.getSimpleName();
    ...
    public byte[] convert(byte[] data) {
        ...
        boolean select = NativeHelper.nv21ToYuv420(mBuffer, data, mPlanar, mSliceHeight, mHeight, mStride, mWidth, mPanesReversed, mSize, mYPadding);
        return select ? mBuffer : data;
    }
