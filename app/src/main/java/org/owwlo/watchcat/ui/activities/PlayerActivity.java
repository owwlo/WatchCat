...
public class PlayerActivity extends Activity implements IVLCVout.OnNewVideoLayoutListener {
    private final static String TAG = PlayerActivity.class.getCanonicalName();
    ...
    protected void onStart() {
        ...
        String streamingIp = intent.getStringExtra(Constants.INTENT_EXTRA_CAMERA_IP);
        int streamingPort = intent.getIntExtra(Constants.INTENT_EXTRA_CAMERA_PORT, 0);
        String streamingUri = Utils.getCameraStreamingURI(streamingIp, streamingPort);
        ...
        Media media = new Media(mLibVLC, Uri.parse(streamingUri));
