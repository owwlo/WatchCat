...
/* package */ public final class FakePlayer extends StubExoPlayer {
  ...
  /** Sets the {@link State} of this player. */
  public void setState(@State int state, boolean playWhenReady) {
